...
//files
int write_to_file(char const *nomealg,char *nomefich,int *sol, int m, int g,int custo,float mbf,struct info param, int numiter,int flagenum,double elapsed,int flagWriteAlg);